      ...
      <form className="bg-white rounded-lg shadow-2xl w-1/4 border-2">
        ...
        <div className="p-3">
          <div className="grid grid-cols-1/5 items-end gap-y-7">
            ...
            <input
              ...
              value={description}
              required
              className="pt-3 border-0 text-gray-400 pb-2 w-full border-b-2 border-gray-500 focus:outline-none focus:ring-0 focus:border-teal-500"
        ...
        <footer className="flex justify-end border-t p-3 mt-5">
          <button
            ...
            className="bg-teal-500 hover:bg-teal-600 px-6 py-2 rounded text-white"
          >
            Save
          </button>
        </footer>
